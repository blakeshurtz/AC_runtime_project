library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/cruz/fccc.csv")
x <- d$x
...
abline(v = 0.5) #placeholder to check threshold
...
#plots
fccc_cl = 0.98 #insert from spreadsheet
