library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/violette/fccc.csv")
x <- d$x
...
abline(v = .6) #placeholder to check threshold
...
#plots
fccc_cl = .98 #insert from spreadsheet
