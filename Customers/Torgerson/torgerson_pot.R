library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/torgerson/fccc.csv")
x <- d$x
...
abline(v = .5) #placeholder to check threshold
...
#plots
fccc_cl = 1.26 #insert from spreadsheet
