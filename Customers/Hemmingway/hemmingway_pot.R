library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/hemmingway/fccc.csv")
x <- d$x
...
abline(v = .25) #placeholder to check threshold
...
#plots
fccc_cl = 0.95 #insert from spreadsheet
