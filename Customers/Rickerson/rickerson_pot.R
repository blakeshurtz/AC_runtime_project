library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/rickerson/fccc.csv")
x <- d$x
...
abline(v = .3) #placeholder to check threshold
...
#plots
fccc_cl = 1.08 #insert from spreadsheet
