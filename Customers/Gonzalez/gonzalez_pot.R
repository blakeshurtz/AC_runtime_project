library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/gonzalez/fccc.csv")
x <- d$x
...
abline(v = .2) #placeholder to check threshold
...
#plots
fccc_cl = NA #insert from spreadsheet
