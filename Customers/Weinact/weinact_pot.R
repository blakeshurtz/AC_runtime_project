library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/weinact/fccc.csv")
x <- d$x
...
abline(v = .4) #placeholder to check threshold
...
#plots
fccc_cl = 1.01 #insert from spreadsheet
