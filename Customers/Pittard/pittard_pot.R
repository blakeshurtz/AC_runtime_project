library(readr)
library(POT)
d <- read_csv("D:/Google Drive/R/Projects/AC_runtime_project/Customers/pittard/fccc.csv")
x <- d$x
...
abline(v = .8) #placeholder to check threshold
...
#plots
fccc_cl = 1.02 #insert from spreadsheet
